...
# ggsave('lefse_cladogram.png', p_clad, width=8, height=8)

# 导出差异物种丰度矩阵
sig_features <- marker_table(mm_lefse)$feature
abun_diff <- abun_mat[sig_features, , drop=FALSE]
write.csv(abun_diff, 'lefse_diff_abundance_matrix.csv')
