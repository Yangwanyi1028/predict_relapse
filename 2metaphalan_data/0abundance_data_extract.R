...
# 输出IBDR样本ID到txt文件
write.table(ibdr_samples, "2metaphalan_data/IBDR_sample_ids.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)

# 输出Longitude样本ID到txt文件
write.table(longitude_samples, "2metaphalan_data/Longitude_sample_ids.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)

# 输出ENIGMA样本ID到txt文件
write.table(enigma_samples, "2metaphalan_data/ENIGMA_sample_ids.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)
# ------------- 读取数据文件 -------------
# 读取对照表 - ID映射关系
...
# 输出ENIGMA匹配结果
write.table(enigma_scd_ids, "2metaphalan_data/ENIGMA_SCD_ids.txt", row.names = FALSE, col.names = FALSE, quote = FALSE)

# 输出完整的ENIGMA匹配记录
write.csv(enigma_matching_records, "2metaphalan_data/ENIGMA_ID_mapping.csv", row.names = FALSE)
