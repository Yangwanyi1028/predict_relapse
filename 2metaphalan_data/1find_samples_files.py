...
# 要搜索的目录
search_dirs = ["2metaphalan_data/3_metaphlan4", "2metaphalan_data/ALL-metaphlan4", "2metaphalan_data/CD_Cohort2_174_118"]
...
# 将结果写入文件
with open("2metaphalan_data/longtitude_sample_files.txt", "w") as f:
...
# 读取样本ID列表
with open("2metaphalan_data/IBDR_sample_ids.txt", "r") as f:
...
# 将结果写入文件
with open("2metaphalan_data/IBDR_sample_files.txt", "w") as f:
    for file_path in result_files:
        f.write(f"{file_path}\n")
...
# 读取样本ID列表
with open("2metaphalan_data/ENIGMA_SCD_ids.txt", "r") as f:
    sample_ids = [line.strip() for line in f if line.strip()]
...
# 将结果写入文件
with open("2metaphalan_data/ENIGMA_sample_files.txt", "w") as f:
    for file_path in result_files:
        f.write(f"{file_path}\n")
